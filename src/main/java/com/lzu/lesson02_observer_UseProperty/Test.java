...
public class Test {
    public static void main(String[] args) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        String[] observers = properties.getProperty("observer").split(",");
        for (String observer : observers) {
            WakenUpListener wakenUpListener = (WakenUpListener) Class.forName(observer).newInstance();
            child.addWakenUpListener(wakenUpListener);
        }
